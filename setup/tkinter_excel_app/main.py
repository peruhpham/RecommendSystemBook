...
def load_data():
    path = r"D:\Project_Recommendation_Systems\tkinter_excel_app\people.xlsx"
...
def insert_row():
    ...
    path = r"D:\tkinter_excel_app\people.xlsx"
    workbook = openpyxl.load_workbook(path)
    sheet = workbook.active
...
# Kiểm tra đường dẫn file tcl
try:
    root.tk.call("source", r"D:\Project_Recommendation_Systems\tkinter_excel_app\forest-dark.tcl")
    root.tk.call("source", r"D:\Project_Recommendation_Systems\tkinter_excel_app\forest-light.tcl")
except tk.TclError as e:
    print(f"Lỗi tcl: {e}. Kiểm tra file tcl và các file PNG liên quan.")
style.theme_use("forest-dark")
